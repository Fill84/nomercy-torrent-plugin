...
| E4 | **Kickass answers a full release name with that release's own page**, not a listing. | When the site reader finds no rows, a magnet anywhere on the page is taken; fixture is the redirected page. |
